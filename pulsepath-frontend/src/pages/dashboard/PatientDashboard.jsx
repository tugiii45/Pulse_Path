...
// Get a simple greeting based on the current time
const getGreeting = () => {
...
function PatientDashboard() {
  ...
  // Load logged-in patient's profile
  useEffect(() => {
  ...
  // Get patient's name from the profile response
  const patientName =
   ...
   *
   * We will replace these with backend data
   * as we connect each PulsePath endpoint.
   */
